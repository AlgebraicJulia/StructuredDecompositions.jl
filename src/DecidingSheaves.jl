...
Base.showerror(io::IO, e::DecompError) = print(io, "Expecting a codecomposition but received a decomposition")
...
The algorithm is as follows: 
  ...
  4. answer (providing a witness)
    ...
    "yes" otherwise.
"""
function decide_sheaf_tree_shape(f, d::StructuredDecomposition, 
